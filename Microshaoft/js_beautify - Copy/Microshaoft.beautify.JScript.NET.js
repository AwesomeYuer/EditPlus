 ...
 *			Microshaoft.beautify.JScript.NET.js
 ...
 *			C:\Windows\Microsoft.NET\Framework64\v4.0.30319\jsc.exe Microshaoft.beautify.js
 */
...
var P_A_C_K_E_R =
{
	detect: function (str)
	{
		return P_A_C_K_E_R._starts_with(str.toLowerCase().replace(/ +/g, ''), 'eval(function(') || P_A_C_K_E_R._starts_with(str.toLowerCase().replace(/ +/g, ''), 'eval((function(');
	},
	unpack: function (str)
	{
		var unpacked_source = '';
...
print(" * Thanks for \"http://jsbeautifier.org/\" supply \"https://github.com/einars/js-beautify\"");
print(" */");
var opts =
			{
				indent_size: 1,
